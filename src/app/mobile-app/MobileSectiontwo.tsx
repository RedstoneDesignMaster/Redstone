...
const MobileSectiontwo = () => {
  return (
    <div className="px-8 pt-8 sm:px-20 ">
      <h5 className="text-center text-xl sm:text-2xl font-extrabold leading-8  text-wrap  ">
      ...
      <p className="text-center text-wrap text-gray-600 sm:text-gray-800 text-sm sm:text-base pb-6 sm:px-14">
        ...
        sustain an action to follow. We combine innovative layouts with
        exceptional coding and spare no bugs or loopholes in the mobile
        application. We create absolute game-changers for your business. With
        sheer experience in the market, our work is immensely recognized and
        trusted among the industries.
      </p>
      <p className="text-center text-wrap text-gray-600 sm:text-gray-800 text-sm sm:text-base pb-6 sm:px-14">
        We create mobile apps that are coherent over all electronic devices and
        software.
      </p>
    </div>
  );
